...
def fn1():
  ...
  try:
        ...
        lblTimes['text'] = 'Invalid input! Please enter an integer.'
        return
...
score = tk.IntVar()
lbl01 = tk.Label(win, width = 10, text = ('Guess the number:'), font = ('Arial', 14))
lbl02 = tk.Label(win, width = 10, text = ('Enter your guess:'), font = ('Arial', 14))
txt01 = tk.Entry(win, width = 30, textvariable = score)
btn01 = tk.Button(win, text = 'Enter', command = fn1)
lblResult = tk.Label(win, width = 30, text = ('The answer is between 0 and 100'), font = ('Arial', 12))
lblTimes = tk.Label(win, width = 35, text = (''), font = ('Arial', 12))
